...
#define SMALLFISH_MOVE_FORCE			4000.f
#define BIGFISH_MOVE_FORCE				4000.f

#define SMALLFISH_PULL_FORCE 1000.f
#define BIGFISH_PULL_FORCE 1100.f
...
#define	LINK_BIT_BATABATA		0x00000010
...
#define LINK_TOOL_BIT_BOW				0x00000020

#define LINK_ITEM_OFFSET 70.f


#define LINK_ZOOM_CAMERA_LEFT_OFFSET 200.f
#define LINK_ZOOM_CAMERA_FORWARD_OFFSET -40.f
#define LINK_ZOOM_CAMERA_UP_OFFSET 50.f
