...
#include "ToFieldTriggerBox.generated.h"

class UBoxComponent;
UCLASS()
class DREAMINGISLAND_API AToFieldTriggerBox : public ATriggerBox
{
	GENERATED_BODY()

public:
	AToFieldTriggerBox(const FObjectInitializer& ObjectInitializer);
